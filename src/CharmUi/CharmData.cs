...
namespace KnightInCradle.CharmUi
{
    ...
    public static class CharmDatabase
    {
        ...
        public static readonly CharmData[] All = new CharmData[]
        {
            ...
            new CharmData { Id = 4, IconFile = "4_soul_catcher", Name = "灵魂捕手", Cost = 3,
                LockedText = "MP达到250.",
                Desc = "传说蜗牛萨满曾用它来从周围的世界中吸取灵魂。\n\n用法术攻击敌人时获得额外魔力。" },
            new CharmData { Id = 5, IconFile = "5_shaman", Name = "萨满之石", Cost = 4,
                LockedText = "累计使用100次法术。",
                Desc = "传说包含了萨满学识的神秘护符。\n\n提高法术的威力，对敌人造成更多伤害。" },
            new CharmData { Id = 6, IconFile = "6_soul_eater", Name = "噬魂者", Cost = 5,
                LockedText = "MP达到500.",
            ...
            new CharmData { Id = 14, IconFile = "14_spell_twister", Name = "法术扭曲者", Cost = 4,
            ...
            new CharmData { Id = 33, IconFile = "33_shadow", Name = "锋利之影", Cost = 5,
                LockedText = "习得幻影闪避。",
