...
namespace KnightInCradle
{
    public class KnightInCradleBehaviour : MonoBehaviour
    {
        ...
        /// </summary>
        // 2026-09-26.20：按 docs/护符加成描述.md 对齐加成范围（17/18/19）+ 补齐羁绊（8+36 / 26+34 / 28+29+30 / 14+33）
        internal const string SelfBuildTag = "2026-09-26.20";
        ...
        private static void TryToggle()
        {
            ...
            // 护符33 冲刺段（诺艾尔本体隐藏、正被图片带着飞）期间禁用换人键
            if (CharmEffects.NoelShadowDashActive)
            {
                return;
            }
